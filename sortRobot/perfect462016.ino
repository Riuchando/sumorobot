...
const int angle1 =10000;  //Creates the angle1 variable and assigns it the angle between home position and the first sorting hole (in steps)
...
int grab = 65;          //Creates the grab variable and assigns it to the open rotation angle of the servo
...
void stepMotor(int angle, boolean Dir) {  //Creates the two variable stepMotor function for controlling the NEMA 23
  ...
  delay(50);                            //Delays for the time specified by wait (in milliseconds)
}
...
void gripper(int state) {                 //Creates the single variable gripper function for opening and closing the end effector
  ...
  delay(100);                            //Delays for 1000 milliseconds
}
